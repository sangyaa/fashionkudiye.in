...
<p>Fabric -  Rayon</p>
<p>Type - Kurti + Sharara + Dupatta</p>
<p>Work - Gotta Patti Work</p>
...
// caption
document.getElementById('capId').innerHTML = '3 pcs Suit Collection [Kurti + sharara + Dupatta]';
// price
document.getElementById('pp').innerHTML = '879.00';

// images
let imgF1 = "/fashionkudiye.in/images/Suit/pr10/m.jpg";
let imgF2 = "/fashionkudiye.in/images/Suit/pr10/photo_2022-11-03_12-01-22 (2).jpg";
let imgF3 = "/fashionkudiye.in/images/Suit/pr10/photo_2022-11-03_12-01-22.jpg";
let imgF4 = "/fashionkudiye.in/images/Suit/pr10/photo_2022-11-03_12-01-23 (2).jpg";
let imgF5 = "/fashionkudiye.in/images/Suit/pr10/photo_2022-11-03_12-01-23.jpg";
let imgF6 = "/fashionkudiye.in/images/Suit/pr10/photo_2022-11-03_12-01-24.jpg";
let imgF7 = "/fashionkudiye.in/images/Suit/pr10/photo_2022-11-03_12-01-25.jpg";
    ...
    <div data-thumb="${imgF5}" data-thumb-alt
        ...
        class="woocommerce-product-gallery__image"><a
            href="${imgF6}"><img width="600"
                ...
                <div data-thumb="${imgF7}" data-thumb-alt
        class="woocommerce-product-gallery__image"><a
            href="${imgF7}"><img width="600"
                height="883" src="${imgF7}"
                class="wp-post-image" alt loading="lazy" title="black-1"
                data-caption data-src="${imgF7}"
                data-large_image="${imgF7}"
                data-large_image_width="696"
                data-large_image_height="1024"
                srcset="${imgF7} 600w, ${imgF7} 204w, ${imgF7} 696w"
                sizes="(max-width: 600px) 100vw, 600px"></a></div>
