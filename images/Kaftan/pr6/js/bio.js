...
`<p>Premium quality Georgette Bandhni kaftan with handwork (Cotton lining attached)</p>
...
// caption
document.getElementById('capId').innerHTML = 'New Premium Badhani kaftan set (Handwork)';
// price
document.getElementById('pp').innerHTML = '1140.00';
...
let innerr = document.getElementById('viw').innerHTML = `<figure class="woocommerce-product-gallery__wrapper">
	...
	<video controls>
	<source src = ${imgV} type = "video/mp4"></source>
	</video>
</div>
</figure>`